...
# Unpack height, width, and discard channels # Create a new image array for the filtered result
...
for i in range(1, m - 1):
    for j in range(1, n - 1): 
        ...
        img_new1[i, j] = sum(temp) # Assign the blurred value # Convert to uint8 for display
